...
<img width="1080" height="882" alt="image" src="https://github.com/user-attachments/assets/2b79f095-5c67-45e7-982e-50a2b51099d0" />
...
<img width="1087" height="747" alt="image" src="https://github.com/user-attachments/assets/8be646bc-8ed6-47f4-812e-6868052efbea" />
...
<img width="796" height="112" alt="image" src="https://github.com/user-attachments/assets/e8fbb0ef-2913-40c0-bbcd-b2fbb5c37f03" />
...
<img width="750" height="336" alt="image" src="https://github.com/user-attachments/assets/dc30e4f4-bb22-4577-ad92-c7c4a21f1be1" />
...
<img width="1912" height="510" alt="image" src="https://github.com/user-attachments/assets/b909b5b5-6077-4d60-856c-bf76a1d001e9" />
...
<img width="736" height="343" alt="image" src="https://github.com/user-attachments/assets/229634c3-81d9-4e89-9d0b-cb72a0d25e43" />
...
เปรียบเทียบระหว่าง http และ dio (3 ประเด็น):

1.การแปลงข้อมูล JSON (JSON Decoding):
 http: ได้รับข้อมูลเป็น String ดิบ ต้องเรียกคำสั่ง jsonDecode() เอง
 dio: แปลง JSON เป็น Map หรือ List ให้อัตโนมัติใน response.data โดยไม่ต้องเรียก jsonDecode()
 
2.การส่ง Query Parameters:
 http: ต้องนำตัวแปรมาต่อสตริงเข้ากับ URL เอง (เช่น '?q=$city&appid=$key')
 dio: รองรับพารามิเตอร์ queryParameters: {...} เป็น Map ได้โดยตรง และจัดการ Encode ตัวอักษรพิเศษให้อัตโนมัติ
 
3.การจัดการ Exception:
 http: โยน Exception แยกหลายชนิดตามสถานการณ์ เช่น TimeoutException, ClientException, SocketException
 dio: รวบรวมทุกข้อผิดพลาดเกี่ยวกับเครือข่ายไว้ที่ DioException ตัวเดียว แล้วแยกแยะสาเหตุผ่าน e.type เช่น connectionTimeout, receiveTimeout, connectionError, badResponse ทำให้จัดการได้ง่ายและเป็นระเบียบกว่า
...
<img width="736" height="178" alt="image" src="https://github.com/user-attachments/assets/c3e49fcf-2ca3-425f-81af-8c493c49083a" />
...
<img width="1915" height="1013" alt="image" src="https://github.com/user-attachments/assets/972b0124-64f3-4862-bb97-b1ce49d42747" />
<img width="1912" height="1021" alt="image" src="https://github.com/user-attachments/assets/9266c14d-087b-435a-b2ca-93c82a605ae7" />
<img width="1916" height="1017" alt="image" src="https://github.com/user-attachments/assets/250b2db4-1868-4444-bb61-78b8b2207d9f" />
